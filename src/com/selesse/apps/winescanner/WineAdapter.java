...
public class WineAdapter extends ArrayAdapter<Wine> {
	...
	public WineAdapter(Context context, int textViewResourceId,
			ArrayList<Wine> wine) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (o != null) {
			...
			TextView countryView = (TextView) v
					.findViewById(R.id.rowCountryText);
			...
			TextView commentView = (TextView) v
					.findViewById(R.id.rowCommentText);

			// TODO bad practice, should fix this
			nameView.setText(o.getName().substring(0,
					Math.min(45, o.getName().length())));
			...
			if (o.getDescription().equals("null"))
				...
				descView.setText(o.getDescription().substring(0,
						Math.min(45, o.getDescription().length())));
			...
			if (o.getComment().equals("null"))
				...
				commentView.setText(o.getComment().substring(0,
						Math.min(45, o.getComment().length())));
		}
		return v;
	}
}
